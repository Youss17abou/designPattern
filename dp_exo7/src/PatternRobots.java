public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1= new RobotImpl.RobotBuilder("robot1")
				.withPuissanceBouclier(2)
				.withPuissanceCanon(10)
				.withFreq(100)
				.build();

		//un robot avec un canon de 10,
		// un bouclier de 2,
		// une fréquence de tir de 100
		...
		Robot robot2= new RobotImpl.RobotBuilder("robot2")
				.withPuissanceBouclier(3)
				.withPuissanceCanon(9)
				.withFreq(90)
				.build();
		//un robot avec un canon de 9
		// , un bouclier de 3
		// , une fréquence de tir de 90
